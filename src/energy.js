...
export const CURRENT_SCHEDULE = [
  { label: "Speed 1", rpm: 3250, hours: 8.08, when: "7:00a–3:05p" },
  { label: "Speed 2", rpm: 3000, hours: 2.95, when: "3:05p–6:02p" },
  { label: "Speed 5", rpm: 1350, hours: 12.08, when: "6:50p–6:55a" },
];
...
export const PROPOSED_SCHEDULE = [
  { label: "Turnover", rpm: 2600, hours: 5.08, when: "6:55a–12:00p" },
  { label: "Overnight", rpm: 1350, hours: 10.92, when: "8:00p–6:55a" },
];

export const kWhPerDay = (schedule) =>
  schedule.reduce((t, s) => t + (wattsAtRpm(s.rpm) / 1000) * s.hours, 0);
